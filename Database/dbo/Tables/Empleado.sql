...
(
	...
	, Edad INT NOT NULL CONSTRAINT CHK_Empleado_Edad CHECK(Edad > 18)
	, Sexo VARCHAR(1) NOT NULL CONSTRAINT CHK_Empleado_Sexo CHECK(Sexo = 'F' OR Sexo = 'M')
	, Estado BIT NOT NULL CONSTRAINT DF_Empleado_Estado DEFAULT(0)
